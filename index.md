...
![innovations](/assets/innovations.png){: width="400" }
...
![one-egr](/assets/one-egr.png){: width="400" }
...
![ai-game](/assets/ai-game.png){: width="250" }
...
![ai-game-c](/assets/ai-game-c.png){: width="250" }
...
If the website is not rendering properly, please check out the github [repository](https://github.com/m1ten/101).